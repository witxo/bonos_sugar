...
if ($this->fact_facturas_type == 'recibo')
{
	$this->year = '9999';
}
elseif ($this->fact_facturas_type == 'presupuesto')
{
	$this->year = '8888';
}
elseif ($this->fact_facturas_type == 'factura proveedor')
{
	$this->year = '7777';
}
elseif ($this->fact_facturas_type == 'nomina')
{
	$this->year = '6666';
}
elseif ($this->fact_facturas_type == 'recibo proveedor')
{
	$this->year = '5555';
}
/*****
...
*/
    ...
    if ($_POST['numero_autogen'] == 1 &&  ($this->estado == 'emitida' || $this->estado == 'cobrada' || $this->estado == 'pagada')) {
		if ($this->numero == ''){
      $this->calcularNumero();
       }
	}
...
*/
  ...
  function calcularTotal() {
    ...
    if ($this->repercutido == "") $this->repercutido = 0;
