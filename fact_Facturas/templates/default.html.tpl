...
<td>&nbsp;</td><td>&nbsp;</td>
        ...
        <tr>
          ...
          <td style="width:58%;text-align: right;vertical-align: top;">{{$Buyer.Province}} </td>
                ...
                <tr>
          <td style="width:32%;text-align: right;vertical-align: top;">Modo de pago:</td>
          <td style="width:58%;text-align: right;vertical-align: top;">{{$pago}} </td>
        </tr>
...
{{*   {{if isset($RetencionPorLinea) || isset($ImpuestosPorLinea) }}<td>{{$l.GrossAmount}} </td>{{/if}}   *}}
  ...
  <div class="note">Ingreso en la siguiente cuenta de Laboral Kutxa: ES25 3035 0426 74 4261043714</div>
  
 
 {{if isset($Firma)}}<img src="{{$Firma}}">{{/if}}
