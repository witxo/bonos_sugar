...
class fact_FacturasViewPdfnf extends InvoiceView{
  ...
  function display(){
	...
	$this->ss->assign("Firma",'themes/default/images/firmaysello.png');
  ...
  function get_template(){
    ...
    $rutas = array(
      "custom/modules/fact_Facturas/templates/defaultnf.html.tpl",
      "modules/fact_Facturas/templates/defaultnf.html.tpl",
    );
